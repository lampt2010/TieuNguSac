...
namespace OnlineShop.Controllers
{
    public class ContentController : Controller
    {
        ...
        {
            var model = new CategoryDao().ListAllPaging(page, pageSize);
            int totalRecord = 0;
        ...
        {
            var model = new ContentDao().GetContentNew(5);
        ...
        public ActionResult LoadTapMenu()
        {
            var model = new ContentDao().GetContentNew(4);
