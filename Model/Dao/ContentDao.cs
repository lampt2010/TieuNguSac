...
namespace Model.Dao
{
    public class ContentDao
    {
        ...
        { 
            ...
            var model = db.Contents.Where(x => x.Status == true &&x.Hot==true).Take(5).ToList();
        ...
        public List<Content> GetAllByCategory(long idCategory)
        {
         
           
            var    model = db.Contents.Where(x => x.CategoryID== idCategory).Take(5).ToList();
        ...
        public List<Content> GetContentByCategory(long idCategory,int sl)
        {


            var model = db.Contents.Where(x => x.CategoryID == idCategory).Take(sl).ToList();
